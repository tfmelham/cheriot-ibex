...
// Constant inputs.
Mult_div_sel_i: assert property (`MULT.mult_en_i && `MULTG.mult_state_q == `MULTG.ALBL |-> `MULT.div_sel_i == 1'b0);
Mult_MULL_signed_mode_i: assert property (`MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL |-> `MULT.signed_mode_i == 2'b00);
...
// Mult_ALBL_imd_val_q_i: assert property (`MULT.mult_en_i && `MULTG.mult_state_q == `MULTG.ALBL |-> `MULT.imd_val_q_i[0] == 34'd0);  NO - is ignored
...
Mult_AHBL_imd_val_q_i: assert property (`MULT.mult_en_i && `MULTG.mult_state_q == `MULTG.AHBL |-> `MULT.imd_val_q_i[0] == $past(`MULT.mac_res_d));  
Mult_AHBH_imd_val_q_i: assert property (`MULT.mult_en_i && `MULTG.mult_state_q == `MULTG.AHBH |-> `MULT.imd_val_q_i[0] == $past(`MULT.mac_res_d));  
...
Mult_ALBL: 
   assert property 
     (`MULT.mult_en_i && `MULTG.mult_state_q == `MULTG.ALBL 
      && // --------------------
      `MULT.div_sel_i == 1'b0
        |->
      `MULT.imd_val_d_o[0][31:0] == alxblspec[31:0]);
...
Mult_ALBL_ext: 
   assert property 
     (`MULT.mult_en_i && `MULTG.mult_state_q == `MULTG.ALBL 
      ...
      `MULT.div_sel_i == 1'b0
        |->
      `MULT.imd_val_d_o[0][33:32] == 2'b00);
...
Mult_ALBH_helper: assert property (`MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.ALBL 
                                    ##1 
                                   `MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.ALBH && 
...
Mult_ALBH: assert property (`MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.ALBL
                            |=> 
                            `MULT.mac_res_d[31:0] == $past(alxbspec[31:0]));


Mult_ALBH_ext: assert property (`MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.ALBH |-> `MULT.mac_res_d[33:32] == 2'b00);
...
Mult_AHBL_helper: assert property (`MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.ALBL 
                                    ##1 
                                   `MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.ALBH && 
                                   `MULT.op_a_i == $past(`MULT.op_a_i) && `MULT.op_b_i == $past(`MULT.op_b_i) && 
                                   `MULT.signed_mode_i == 2'b00 && 
                                   ...
                                   `MULT.imd_val_q_i[0] == $past(`MULT.imd_val_d_o[0])
                                    ##1
                                   `MULT.mult_en_i && `MULT.operator_i == MD_OP_MULL && `MULTG.mult_state_q == `MULTG.AHBL && 
